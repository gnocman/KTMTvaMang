...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="{{ asset('css/site-styles.css') }}">
        ...
        <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/v/dt/jq-3.3.1/dt-1.10.22/af-2.3.5/b-1.6.5/cr-1.5.2/fc-3.3.1/fh-3.1.7/kt-2.5.3/r-2.2.6/rg-1.1.2/rr-1.2.7/sc-2.0.3/sb-1.0.0/sp-1.2.1/sl-1.3.1/datatables.min.css"/>
        <script type="text/javascript" src="https://cdn.datatables.net/v/dt/jq-3.3.1/dt-1.10.22/af-2.3.5/b-1.6.5/cr-1.5.2/fc-3.3.1/fh-3.1.7/kt-2.5.3/r-2.2.6/rg-1.1.2/rr-1.2.7/sc-2.0.3/sb-1.0.0/sp-1.2.1/sl-1.3.1/datatables.min.js"></script>
                ...
                <div class="d-flex justify-content-between align-items-center w-100">
                    ...
                    <div class="row">
                        <a href="{{route('home')}}" class="nav-link">
                            <img class="logo mr-4" src="{{asset('images/icons/icon.png')}}"/>
                        </a>
                        @auth
        ...
        <footer>
            <div class="bg-light p-3 d-flex justify-content-center align-items-center">
                <h6 class="text-center">
                    Copyright &copy; {{ now()->year }} <span class="mx-1"> - </span> <a href="{{route('home')}}" class="text-primary">{{config('app.name')}}</a>
                </h6>
            </div>
        </footer>
        @yield('scripts')
